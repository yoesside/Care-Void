  ...
  <div class="container">
   ...
   <div id="navbar" class="navbar-collapse collapse">
     <ul class="nav navbar-nav">
      ...
      <li><a data-scroll href="viewVac.php">Record New Vaccines</a></li>
    ...
    <div class="col-lg-10 col-md-8 col-sm-6 col-xs-12" style="margin-top: 15%; margin-left: 9%;">
      <div class="jumbotron">
        <div class="appointment-form">        
          <h1>Welcome, <?php echo $fullname; ?>!</h1><br>
          <p class="lead">Here is your dashboard. you can manage vaccine batch, and many more!</p>
          <hr class="my-4">
          <p>let's go arrange everything!</p>
          <p class="lead">
            <a class="btn btn-success btn-lg" href="viewVac.php" role="button">Record Batch</a>
          </p>    
        </div>
      </div>
    </div>   

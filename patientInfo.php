...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>Care Void - View Request</title>
   ...
   <nav class="main-menu">
    ...
    <div id="navbar" class="navbar-collapse collapse">
       <ul class="nav navbar-nav">
         ...
         <li><a data-scroll href="recordVac.php">Record New Vaccines</a></li>
         <li><a class="active"data-scroll href="patientInfo.php">View Request</a></li>
      </ul>                     
   </div>
</nav>              
</div>
